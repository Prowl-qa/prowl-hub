      ...
      <div className="container footer-shell">
        <div className="footer-brand">
          <div className="footer-brand-head">
            ...
            <div>
              <span className="footer-brand-name">Prowl Hub</span>
              <p>Community hunt library for Prowl.</p>
        ...
        <nav className="footer-nav" aria-label="Footer">
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li>
                <a href="https://www.npmjs.com/package/prowl-tools" target="_blank" rel="noopener noreferrer">
                  npm
                </a>
              </li>
            </ul>
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li>
                <a href="https://github.com/prowl-tools/prowl" target="_blank" rel="noopener noreferrer">
                  Prowl CLI
                </a>
              </li>
              <li>
                <a href="https://github.com/prowl-tools/prowl-hub" target="_blank" rel="noopener noreferrer">
                  GitHub
                </a>
              </li>
            </ul>
