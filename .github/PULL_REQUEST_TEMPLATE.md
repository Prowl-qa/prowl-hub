...
**Category**: <!-- auth / admin / e-commerce / saas / accessibility -->

**Pattern**: <!-- What does this hunt test? e.g., "Google OAuth login flow" -->
...
- [ ] Filename matches the `name:` field (e.g., `my-hunt.yml` → `name: my-hunt`)
...
<!-- Any additional context, edge cases, or customization tips -->
